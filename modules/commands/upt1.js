...
const time = process.uptime()
  ...
  const Canvas = require('canvas');
    ...
    let background = (await axios.get(encodeURI(`https://i.imgur.com/MfwR4Qh.png`), { responseType: "arraybuffer" })).data;
...
let l1 = await loadImage(pathAva);
  ...
  ctx.drawImage(l1, 320, -100, 700, 800);
    ...
    ctx.fillText("Duy Quốc", 1230, 300);
    ctx.beginPath();
  ////////////////////////////////////////
   registerFont(__dirname + `/tad/DancingScript-VariableFont_wght.ttf`, {
      family: "UTM"
    ...
    ctx.font = "60px UTM";
    ctx.fillStyle = "#FFFFFF";
    ctx.fillText(`${z_1} : ${x_1} : ${y_1} `, 1300, 400);
    ctx.restore();
    ctx.save();
